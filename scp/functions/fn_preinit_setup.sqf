...
private _pos = [[], 0, -1, 0, 0, 0.1, 0, [], []] call BIS_fnc_findSafePos;

// Put a marker on the epicenter -- see, I'm not entirely evil ...
private _marker = createMarker ["mmission_center", _pos];
...
private _nplaces = 20;
private _places = selectBestPlaces [_pos, 5000, _filter, 50, _nplaces];
...
private _cmd = "
    DSA_Core = this; this setVariable ['BIS_fnc_initModules_disableAutoActivation', false, true]; DSA_Core setVariable ['DSA_Debug', 'TRUE', true]; DSA_Core setVariable ['DSA_DetailedDebug', 'TRUE', true]; DSA_Core setVariable ['DSA_RandomDelay', 1, true]; DSA_Core setVariable ['DSA_ArmourProtection', 100, true]; DSA_Core setVariable ['DSA_AttackDowned', 'TRUE', true]; DSA_Core setVariable ['DSA_ACEdamage', 'FALSE', true]; DSA_Core setVariable ['DSA_AnomalySleep', 5, true]; DSA_Core setVariable ['DSA_AnomalyRange', 7, true]; DSA_Core setVariable ['DSA_AddRating', 'FALSE', true]; DSA_Core setVariable ['DSA_DeathFX', 'TRUE', true]; DSA_Core setVariable ['DSA_ActiveIdolChance', 25, true]; DSA_Core setVariable ['DSA_AllowWater', 'FALSE', true]; DSA_Core setVariable ['DSA_Side', 'EAST', true]; DSA_Core setVariable ['DSA_DMPAO', 'TRUE', true]; ";
...
//"DSA_SpawnerMen" createUnit [ _pos, _moduleGroup, _cmd];
...
#################################################################### */
diag_log "Placing starting point";
